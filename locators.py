...
nacionalidad_lista = (By.XPATH, "//div[contains(@class, 'custom-hr-select__value-container')]/div[contains(@class, 'custom-hr-select__placeholder') and text()='Seleccione una opción']")
